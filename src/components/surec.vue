<template>
  <div>
    <h1 class="flex justify-center text-[#80BC00] font-bold text-3xl mt-10 mb-5 tablet:mt-0 tablet:text-5xl ml-auto mr-auto">
      PROJE
      SÜRECİ</h1>
    <div class="container tablet:ml-auto tablet:mr-auto flex flex-col ml-auto mr-auto">


      <div class=" tablet:grid grid-cols-[1fr,1fr] ">
        ...
        >
          ...
          <div
              id="beaf"
              class="absolute top-[165%] tablet:top-[150%] left-[30%] before:content-[''] before:w-[10px] before:h-[135px] before:bg-[rgba(123,152,206,0.25)] before:block before:absolute before:left-[51px] before:bottom-[50px] before:z-[-50]  after:content-[''] after:w-[10px] after:h-[131px] after:bg-[rgba(123,152,206,0.25)] after:block after:absolute after:left-[51px] after:top-[50px] after:z-[-50] tablet:before:h-[127px] tablet:after:w-[270%]  tablet:after:h-[10px] laptop:after:w-[150%] tablet:after:left-[-220%] laptop:after:left-[-94.5%] "
          >
            <img class="" src="@/img/terspanel.svg">
          </div>
        </div>
        <!--1-->
        <div
...
#beaf::before {
  animation: fade-in 5s; /* 2 saniyede animasyonu oynat */
}
